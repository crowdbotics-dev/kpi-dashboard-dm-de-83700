"""
Django settings for kpi_dashboard_dm_de_83700 project.
...
ROOT_URLCONF = 'kpi_dashboard_dm_de_83700.urls'
...
WSGI_APPLICATION = 'kpi_dashboard_dm_de_83700.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kpi_dashboard_dm_de_83700 API",
    "DESCRIPTION": "API documentation for kpi_dashboard_dm_de_83700 App",
    "VERSION": "v1",
}
